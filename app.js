...
(function () {
  ...
  function reportHeight() {
    ...
    try {
      window.parent.postMessage({ type: 'moroject-saju:height', height: h }, '*');
    } catch (e) {  }
  }
  ...
  function render() {
    ...
    if (!isEmbedded) $('panel-now').scrollIntoView({ behavior: 'smooth', block: 'start' });
  }
